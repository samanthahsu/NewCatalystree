...
import com.example.newcatalystree.signIn.MainSignInActivity;
...
public class SettingsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button btWeb = view.findViewById(R.id.btWeb);
...
//        logout button
        Button btOut = view.findViewById(R.id.btOut);
...
//        todo change url to actual website
    ...
    private void openMainActivity() {
        Intent intent = new Intent(getActivity(), MainSignInActivity.class);
